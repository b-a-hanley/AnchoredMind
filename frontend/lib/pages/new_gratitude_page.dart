...
class NewGratitudeForm extends StatefulWidget {
  
  @override
  _NewGratitudeFormState createState() => _NewGratitudeFormState();  // Returning the state of the widget
}

class _NewGratitudeFormState extends State<NewGratitudeForm> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      jsonService.postGratitude(title, mood, journalEntry);
      Navigator.push(
        context,
